 ...
 * @author GiansCode - small but useful changes and 1.13 update
 * @author Ste3et_C0st - add/take advancement logic
 * @author PROgrammer_JARvis - rework and combining
 * @author ysl3000 - useful advice and bug-tracking at Pull Requests/JUnit-Tests, full Builder-Pattern support, Lombok
 */
    ...
    public static class AdvancementAPIBuilder {
        ...
        public AdvancementAPI build() {
            ...
            switch (this.triggers == null ? 0 : this.triggers.size()) {
                case 0:
                    triggers = Collections.singleton(Trigger.builder(Trigger.TriggerType.IMPOSSIBLE, "default"));
                    break;
                case 1:
                    triggers = Collections.singleton(this.triggers.get(0));
                    break;
                default:
